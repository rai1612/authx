...
public class AuthController {
    ...
    public AuthController(AuthService authService, AuditService auditService, EmailService emailService,
    ...
    public ResponseEntity<?> refreshToken(@RequestBody RefreshTokenRequest request) {
        try {
            ...
            try {
                ...
                auditService.logEventSync(user, AuditLog.EventType.TOKEN_REFRESH,
            ...
            auditService.logEventSync(null, AuditLog.EventType.TOKEN_REFRESH,
